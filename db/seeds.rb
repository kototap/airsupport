...
Post.create!(
  [
    ...
    { title: "Chocolatier Masale", post_image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/sample-post6.jpg"), filename: "sample-post6.jpg"), body: "空港内にあり、ブラウニーもアイスも美味しい！", address: "ショコラティエマサール　新千歳空港出発ロビー店", airport: "札幌新千歳空港", is_draft: false, tag_id: tags[2].id, user_id: users[3].id },
    { title: "你好本店", post_image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/sample-post10.jpg"), filename: "sample-post10.jpg"), body: "蒲田の餃子といえばここ\n羽田空港から電車で10分ほど、駅から徒歩5分で着きます！", address: "你好本店", airport: "羽田空港", is_draft: false, tag_id: tags[1].id, user_id: users[4].id },
    { title: "コム・シノワ", post_image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/sample-post8.jpg"), filename: "sample-post8.jpg"), body: "焼きたてのパンが食べられました。\n8時から開いているのでありがたかったです。", address: "兵庫県神戸市中央区御幸通7-1-15", airport: "神戸空港", is_draft: false, tag_id: tags[2].id, user_id: users[4].id },
    { title: "むつか堂", post_image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/sample-post7.jpg"), filename: "sample-post7.jpg"), body: "空港から10分！\n博多駅の駅ビルにあります。\n食パン専門店なので本当に美味しいです！", address: "福岡県福岡市博多区博多駅中央街1-1 アミュプラザ博多5F", airport: "福岡空港", is_draft: false, tag_id: tags[2].id, user_id: users[0].id },
    ...
    { title: "AIMAI", post_image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/sample-post4.jpg"), filename: "sample-post4.jpg"), body: "おしゃれなカフェでした。カフェラテも美味しい！", address: "福岡県福岡市博多区博多駅前4-32-14", airport: "福岡空港", is_draft: false, tag_id: tags[2].id, user_id: users[2].id }
  ]
)
